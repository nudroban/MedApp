...
class RecomendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recomendation" do
    assert_difference("Recomendation.count") do
      post recomendations_url, params: { recomendation: { body: @recomendation.body, title: @recomendation.title } }
    end
  ...
  test "should update recomendation" do
    patch recomendation_url(@recomendation), params: { recomendation: { body: @recomendation.body, title: @recomendation.title } }
